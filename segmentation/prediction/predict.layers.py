...
MODEL_NAME = 'model.trilayer.unet.34'
...
def run_predictions():
    ...
    for i in range(1, 928):
        ...
        cv2.imwrite('test_masks_layer/test_mask_'+str(i)+'.jpg', prediction)
...
def gen_encodings():
    masks = ['test_masks_layer/test_mask_'+str(x)+'.jpg' for x in range(1, 928)]
    encodings = []
