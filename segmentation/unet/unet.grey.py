...
def get_train_imgs():
    return ['../data/training_grey/images/train_img_'+str(x)+'.jpg' for x in range(1, 1501)]


def get_train_masks():
    return ['../data/training_grey/masks/train_mask_'+str(x)+'.ppm' for x in range(1, 1501)]


def get_val_imgs():
    return ['../data/validation_grey/images/validation_img_'+str(x)+'.jpg' for x in range(1, 501)]


def get_val_masks():
    return ['../data/validation_grey/masks/validation_mask_'+str(x)+'.ppm' for x in range(1, 501)]
...
def transform_img(img, mask):
    theta = randint(-200, 200) / 1800
    zoom = randint(900, 1100) / 1000
...
def generate_data(x_path, y_path, batch):
    ...
    img_shape = (batch, IMG_HEIGHT, IMG_WIDTH)
    mask_shape = (batch, IMG_HEIGHT, IMG_WIDTH)
