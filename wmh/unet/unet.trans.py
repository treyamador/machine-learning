...
def generate_data(x_path, y_path, transf):
...
def train_model(model, epochs):
    ...
    model.compile(optimizer=SGD(lr=1e-4), loss=dice_coef_loss)
    ...
    model.fit_generator(generate_data(train_imgs, train_masks, transform_img),
                        ...
                        validation_data=generate_data(val_imgs, val_masks, untransform_img),
